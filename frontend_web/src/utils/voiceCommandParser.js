...
export const findStudentRowSmart = (tableData, searchName, recentStudents = [], targetColumn = null) => {
  ...
  // 🔥 Strategy 2: Recent context resolution (only for single matches now)
  ...
  // 🔥 Strategy 3: Empty score preference (only for single matches now)
  if (targetColumn) {
  ...
  // 🔥 Strategy 4: High confidence single match
  ...
  // Strategy 5: Best available match
